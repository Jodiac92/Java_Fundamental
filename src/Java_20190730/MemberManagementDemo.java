...
public class MemberManagementDemo {
	...
	//1.검색할 아이디를 입력 받는다.
	//2.ArrayList에 member 객체에 검색할 아이디를 찾아서 있으면 출력하고 없으면 검색된 결과가 없습니다. 메시지출력
	//3.ArrayList에 있는 모든 고객을 출력한다.
	//4.print()호출
	//5.번호를 선택하세요> 메세지를 출력한 후 키보드를 입력을 받게 한다.
	private void search() {
		// TODO Auto-generated method stub
	...
	//1.삭제할 아이디를 입력받는다.
	//2.ArrayList의 Member 객체중에서 삭제할 아이디를 찾아 있으면 삭제하고 없으면 삭제할 아이디가 없습니다. 메세지 출력.
	//3.ArrayList에 있는 모든 고객을 출력한다.
	//4.print()호출
	//5.번호를 선택하세요> 메세지를 출력한 후 키보드를 입력을 받게 한다.
	private void delete() {
	...
	// 6.번호를 선택하세요> 메세지를 출력한 후 키보드를 입력을 받게 한다.
	private void insert() {
		// TODO Auto-generated method stub
	...
	//1.수정할 아이디를 입력받는다.
	//2.ArrayList에 있는 고객정보 중에서 수정할 아이디를 찾아서 있으면 수정할 이름을 입력받고, ArrayList 고객정보를 수정하고, 없으면 수정할 아이디가 없습니다. 메세지 출력한다.
	//3.ArrayList에 있는 모든 고객을 출력한다.
	//4.print()메서드 호출
	//5.번호를 선택하세요> 메세지를 출력한 후 키보드를 입력을 받게 한다.
	private void update() {
